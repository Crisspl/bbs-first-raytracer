...
NBL_GLSL_API vec2 nbl_glsl_barycentric_reconstructBarycentrics(in vec3 positionRelativeToV0, in mat2x3 edges)
{
...
NBL_GLSL_API vec2 nbl_glsl_barycentric_reconstructBarycentrics(in vec3 pointPosition, in mat3 vertexPositions)
{
...
NBL_GLSL_API vec3 nbl_glsl_barycentric_expand(in vec2 compactBarycentrics)
{
