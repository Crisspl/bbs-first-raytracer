...
#include <3rdparty/glsl/sampling/bilinear.glsl>
#include <3rdparty/glsl/sampling/spherical_triangle.glsl>

NBL_GLSL_API vec4 nbl_glsl_sampling_computeBilinearPatchForProjSphericalTriangle(in mat3 sphericalVertices, in vec3 receiverNormal, in bool isBSDF)
{
...
NBL_GLSL_API vec3 nbl_glsl_sampling_generateProjectedSphericalTriangleSample(out float& rcpPdf, in float solidAngle, in vec3 cos_vertices, in vec3 sin_vertices, in float cos_a, in float cos_c, in float csc_b, in float csc_c, in mat3 sphericalVertices, in vec3 receiverNormal, in bool isBSDF, vec2 u)
{
...
NBL_GLSL_API vec3 nbl_glsl_sampling_generateProjectedSphericalTriangleSample(out float& rcpPdf, in vec3 cos_sides, in vec3 csc_sides, in vec3 cos_vertices, in mat3 sphericalVertices, in vec3 receiverNormal, in bool isBSDF, vec2 u)
{
...
NBL_GLSL_API vec3 nbl_glsl_sampling_generateProjectedSphericalTriangleSample(out float& rcpPdf, in mat3 sphericalVertices, in vec3 receiverNormal, in bool isBSDF, vec2 u)
{
...
NBL_GLSL_API vec3 nbl_glsl_sampling_generateProjectedSphericalTriangleSample(out float& rcpPdf, in mat3 vertices, in vec3 origin, in vec3 receiverNormal, in bool isBSDF, in vec2 u)
{
...
//
NBL_GLSL_API float nbl_glsl_sampling_probProjectedSphericalTriangleSample(in float solidAngle, in vec3 cos_vertices, in vec3 sin_vertices, in float cos_a, in float cos_c, in float csc_b, in float csc_c, in mat3 sphericalVertices, in vec3 receiverNormal, in bool receiverWasBSDF, in vec3 L)
{
    float pdf;
...
NBL_GLSL_API float nbl_glsl_sampling_probProjectedSphericalTriangleSample(in mat3 sphericalVertices, in vec3 receiverNormal, in bool receiverWasBSDF, in vec3 L)
{
    float pdf;
